# Contributing to Cubacel Connect

Thanks for your interest in improving Cubacel Connect! This document explains how to propose changes.
...
4. Open `CubacelConnect.xcodeproj` and build.

## Updating the USSD Catalog

All codes live in `CubacelConnect/Resources/ussd_codes.json`. When adding or changing a code:
